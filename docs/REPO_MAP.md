...
更新时间：2026-07-28（M0.2/M0.3 已实现共享契约与 Provider 初始配置投影；M1.1–M1.7 已实现私有扑克规则，M1.R 已完成纯状态去版本化）
