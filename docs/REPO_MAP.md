...
更新时间：2026-07-27（M0.2/M0.3 已实现共享契约与 Provider 初始配置投影；M1.1–M1.4 已实现私有扑克状态、确定性发牌、牌型评估、座位拓扑与盲注边界）
