...
const PokerPrivateEventSchema = z.discriminatedUnion('type', [
...
export type PokerPrivateEvent = PokerDomainEventDraft
...
export function createPokerPrivateEvent(input: unknown): PokerPrivateEvent {
  try {
    const parsed = PokerPrivateEventSchema.parse(input)
